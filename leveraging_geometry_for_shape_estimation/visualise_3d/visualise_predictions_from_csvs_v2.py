...
def visualise(projectdir,output_dir,shape_net_dir,color,scene_results):
        ...
        for file0 in tqdm(glob.glob(projectdir + "/*.csv")):
            ...
            for alignment in alignments: # <- multiple alignments of same object in scene
                ...
                sampled_points = sample_points_from_meshes(mesh,num_samples=4000)
...
if __name__ == "__main__":
    ...
    # for add_on in ['_scan2cad_constraints_filtered_no_rotation']:
        ...
        visualise(projectdir,output_dir,shape_net_dir,color,scene_results)
