...
def main(exp1,exp2,exp3,exp4):
    ...
    dir1 = exp1 + '/lines_2d_filtered_vis'
    dir2 = exp2 + '/lines_2d_filtered_vis'
    dir3 = exp1 + '/T_lines_vis_old_model_gt'
    # dir4 = exp1 + '/non'

    check_all_exist = False

    outdir = exp1 + '/lines_comparison_vis'
    print(outdir)
    if not os.path.exists(outdir):
        os.mkdir(outdir)
    for name in tqdm(sorted(os.listdir(dir1))):
        ...
        img2 = load_image(dir2 + '/' + name,img_size)
        img3 = load_image(dir3 + '/' + name,img_size)
        img4 = load_image(dir4 + '/' + name,img_size)
...
if __name__ == '__main__':
    ...
    # exp3 = sys.argv[3]
    # exp4 = sys.argv[4]
    exp2 = '/scratch2/fml35/experiments/leveraging_geometry_for_shape/exp_186_roca_retrieval_gt_z_lines_octopus'
    exp1 = '/scratch2/fml35/experiments/leveraging_geometry_for_shape/exp_198_lines_gt_z_expanded_bbox'
