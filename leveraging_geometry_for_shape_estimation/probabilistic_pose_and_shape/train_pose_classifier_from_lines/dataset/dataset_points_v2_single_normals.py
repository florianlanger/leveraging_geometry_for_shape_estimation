...
print('import dataset_v3 for classification')
from leveraging_geometry_for_shape_estimation.probabilistic_pose_and_shape.train_pose_classifier_from_lines.dataset.dataset_v3_combine_classification_and_regression import load_numpy_dir,get_gt_infos,get_gt_infos_by_detection,bbox_to_lines,reproject_3d_lines,check_config,compute_lines_resized_torch,Dataset_lines,compute_lines_resized
...
class Dataset_points(Dataset_lines):
    ...
    def __init__(self,config,kind,use_all_images=False):
        ...
        # self.best_rotation_indices = load_json('/scratches/octopus/fml35/experiments/regress_T/evals/date_2022_07_08_time_18_07_18_EVAL_REFINE_1_date_2022_07_05_time_11_57_34_3_refinements_half_classifier_half_regressor_4_rotations_network_epoch_000200_norm_medium_rotation_index_0/predictions/epoch_000050/translation_pred_scale_pred_rotation_init_for_classification_retrieval_roca_all_images_True/best_rotation_index.json')
    ...
    def get_number_total_points(self):
        ...
        if self.config['data']['use_3d_points'] == True:
            points_reprojected = self.config['data']['n_points_3d']
    ...
    def create_embedding_3d(self,model_3d_name,R,T,S,img_size,K):
        ...
        # change here
        normals = normals[:,:n_normals_per_3d,:]
        ...
        # change here
        list_for_concat = [torch.repeat_interleave(points_plus_channel,repeats=n_normals_per_3d,dim=0),normals_rotated,torch.repeat_interleave(depth,repeats=n_normals_per_3d,dim=0)]
        ...
        if self.config["data"]["input_3d_coords"] == True:
            list_for_concat.append(torch.repeat_interleave(cc1,repeats=n_normals_per_3d,dim=0))

        if self.config["data"]["input_rgb"] == True:
            list_for_concat.append(torch.repeat_interleave(cc1,repeats=n_normals_per_3d,dim=0) * 0)
