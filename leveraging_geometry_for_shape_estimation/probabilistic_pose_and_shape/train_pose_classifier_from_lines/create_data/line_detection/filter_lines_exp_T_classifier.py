...
def main():
    ...
    for name in tqdm(sorted(os.listdir(target_folder + '/gt_infos'))):
        ...
        for i in range(len(gt_infos['objects'])):
            ...
            output_path_lines = target_folder + '/lines_2d_filtered/' + detection_name + '.npy'
            vis_path = target_folder + '/lines_2d_filtered_vis/' + detection_name + '.png'
