...
def evaluate(projectdir,outputdir,results_file_cats,results_file_scenes,global_config,filename_cad_appearance, filename_annotations,use_tolerant_rotation=False):
    ...
    for force_same_retrieval in [False,True]:
        ...
        for file0 in glob.glob(projectdir + "/*.csv"):
            ...
            # CSVHelper.write(outputdir + '_' + add_on + '_tolerant_rotation/' + id_scan + '.csv',appended_alignments)
...
if __name__ == "__main__":
    ...
    # for use_tolerant_rotation,add_on in zip([True],["_tolerant_rotation"]):
        ...
        evaluate(projectdir,outputdir,results_file_cats,results_file_scenes,global_config, scan2cad_dir +  "cad_appearances.json", scan2cad_dir + "full_annotations.json",use_tolerant_rotation=use_tolerant_rotation)