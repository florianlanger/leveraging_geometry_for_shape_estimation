...
def evaluate(in_dir,out_dir,filename_annotations):

    # -> define Thresholds
    threshold_translation = 0.4 # <-- in meter
    threshold_rotation = 1000 # <-- in deg
...
if __name__ == "__main__":
    ...
    in_dir = target_folder + '/global_stats/eval_scannet/results_per_scene'
    out_dir = target_folder + '/global_stats/eval_scannet/results_per_scene_filtered_no_rotation'
    ...
    # in_dir = '/scratch2/fml35/results/MASK2CAD/results_per_scene'
    # out_dir = '/scratch2/fml35/results/MASK2CAD/results_per_scene_filtered_04_40_40'
    # scan2cad_dir = '/scratch2/fml35/datasets/scannet/scan2cad_annotations/'
    evaluate(in_dir,out_dir,scan2cad_dir + "full_annotations.json")