...
def evaluate(path_csv, filename_cad_appearance, filename_annotations):
    ...
    # for file0 in glob.glob(path_csv):
        alignments = CSVHelper.read(path_csv)
...
if __name__ == "__main__":
    ...
    path_csv = '/scratch2/fml35/results/ROCA/raw_results.csv'
    evaluate(path_csv, scan2cad_dir +  "cad_appearances.json", scan2cad_dir + "full_annotations.json")