...
python leveraging_geometry_for_shape_estimation/data_conversion/reformat_pix3d_imgs.py $1
python leveraging_geometry_for_shape_estimation/data_conversion/create_visualisation_list.py $1
