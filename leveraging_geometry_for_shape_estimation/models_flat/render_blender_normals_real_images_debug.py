...
def main():
    ...
    for j in range(0,len(pix3d)):
        ...
        if not 'bed/0001' in pix3d[j]["img"]:
            continue
        ...
        imported_object = bpy.ops.import_scene.obj(filepath='/scratch/fml35/experiments/test_output_all_s2/models/remeshed/' + pix3d[j]["model"].replace('model/',''))
