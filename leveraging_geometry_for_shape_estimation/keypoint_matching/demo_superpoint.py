...
if __name__ == '__main__':
  ...
  parser.add_argument('--show_extra',type=bool,default=True,
  ...
  parser.add_argument('--no_display', type=bool,default=True,
  ...
  for i in range(1):
    opt.input = 'image_pairs/pair_{}'.format(i)
    opt.write_dir = 'tracker_outputs/pair_{}_second_try/'.format(i)
    ...
    while True:
      ...
      print(tracks.shape)
      # print(tracker.all_pts)
      # for i in range(tracks.shape[0]):

      #   print(tracker.all_pts[int(tracks[i,-1])],tracker.all_pts[int(tracks[i,-2])])
