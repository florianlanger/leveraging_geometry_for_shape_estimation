...
def get_keypoints_for_folder(folder_input,folder_output,folder_vis,super_point,visualise,run_on_octopus):
    ...
    for dirpath, dirnames, filenames in tqdm(os.walk(folder_input)):
        for name in filenames:
            ...
            if visualise == "True" and vis_counter < 100:
...
def main():
    ...
    visualise = False
    get_keypoints_for_folder(folder_input_rendered,folder_output_rendered,folder_vis_rendered,super_point_network,visualise,run_on_octopus)
